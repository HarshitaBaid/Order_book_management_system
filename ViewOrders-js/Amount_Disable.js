document.addEventListener("DOMContentLoaded", function () {
    ...
    var particularAmountInput = document.getElementById("exact_amount");
    var lessThanAmountInput = document.getElementById("less_than_amount");
    var greaterThanAmountInput = document.getElementById("greater_than_amount");
